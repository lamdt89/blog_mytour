...
if($submitform == "Cập nhật"){
   $myform->add("vop_name", "vop_name", 0, 0, 0, 0);
...
<html xmlns="http://www.w3.org/1999/xhtml">
   <head>
      ...
      $db_data = new db_query("SELECT * FROM " . $fs_join_table . " WHERE " . $id_field . " = " . $record_id);
   ...
   <body topmargin="0" bottommargin="0" leftmargin="0" rightmargin="0">
      ...
      <p align="center" style="padding-left:10px;">
         ...
         <?=$form->text("Tên đánh giá", "vop_name", "vop_name", $row['vop_name'], "Tên vote", 0, 350,20)?>
         
         <tr>
            <td class="form_name">Thuộc bài viết :</td>
            <td class="form_text">
               <a target="blank" href="../../../<?='p'.$row['pos_id'].'-'.$article->removeTitle($row['pos_title'])?>.html" class="link_p"><?=$row['pos_title'].".html"?></a>
            </td>
         </tr>
