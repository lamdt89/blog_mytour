...
<script src="<?php print $fmWebPath; ?>/js/common.js" type="text/javascript"></script>
...
fmEncoding = '<?php print addslashes($fmEncoding); ?>';
fmMsg = new Array();
...
<div id="fmMenu" class="fmDialog">
<table border="0" cellspacing="0" cellpadding="0" width="100%"><tr>
<td id="fmMenuText" class="fmTH1" style="padding:4px; cursor:move" align="left" nowrap="nowrap"></td>
<td class="fmTH1" style="padding:2px; cursor:move" align="right"><?php print fmCloseButton(); ?></td>
</tr><tr>
<td class="fmTH1" colspan="2" style="padding:1px">
