...
/* PUBLIC METHODS ****************************************************************************** */
	 ...
	 * @return ListingIcon
	 */
	function ListingIcon(&$FileManager, $dir = '', $search = '') {
		parent::Listing($FileManager, $dir, $search);
		$this->cellsPerRow = floor($this->listWidth / 100);
		$this->cellWidth = number_format(100 / $this->cellsPerRow, 2);
		$this->nameMaxLen = round($this->cellWidth * $this->listWidth / 1000);
	}
	...
	function &switchView() {
		...
		return new ListingDetail($this->FileManager, $this->curDir, $this->searchString);
	}
...
/* PROTECTED METHODS *************************************************************************** */
	...
	function viewHeader() {
		parent::viewHeader();
		print "<table border=\"0\" cellspacing=\"2\" cellpadding=\"5\" width=\"100%\" class=\"fmTH2\">\n";
		print "<colgroup>\n";
