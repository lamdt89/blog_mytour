<?	
	...
	$post = array();
	$count_post = 6;
 	$first_post = ($lpage-1)*$count_post;	
	$sql = "SELECT * FROM posts WHERE pos_cat_id ".$where_clause." ORDER BY pos_id DESC LIMIT ".$first_post.",".$count_post;
...
<div class="row list-post">
	...
	<div class="col-md-12">
		<div class="row">
			<div class="col-md-3">
				<a href="http://<?=$_SERVER['HTTP_HOST'].'/p'.$item['pos_id'].'-'.$string?>.html"><img width="100%" height="130px" src="http://<?=$_SERVER['HTTP_HOST']?>/uploads/images/posts/<? echo date('Y/m/d/',$item['pos_time']).$item['pos_img'] ?>"></a>
			</div>
