...
class tinyMCE{
	...
	*/
	...
	function tinyMCE($content, $text_area_id, $textarea_width="500", $textarea_height="300", $show_math=0, $js_path="/js/tinyMCE/"){
		...
		$this->html_output .= '<script type="text/javascript" src="' . $js_path . 'tinymce.min.js"></script>' . "\n";
		$this->html_output .= '
			<script type="text/javascript">
				...
				tinyMCE.init({
					...
					/* Theme options */
					theme_advanced_buttons1 : "bold,italic,underline,strikethrough,|,justifyleft,justifycenter,justifyright,justifyfull,fontselect,fontsizeselect,forecolor,backcolor,pasteword,link,unlink,emotions,|,table,tablecontrols,code' . $math_control . '",
