...
class form{
	...
	var $class_form_button			= 'form_button btn btn-primary';		// Style của button control
	var $class_form_name				= 'form_name';			// Style của tên control
	var $class_form_control			= 'form_control';		// Style của control
   var $class_form_title         = 'form_title';
   ...
   // Generate control in table
	function create_title_form($title = ''){
		if($title == "")   return ':';
		
		return '<tr' . $this->tr_html . '><td class="' . $this->class_form_name . '"></td><td class="' . $this->class_form_title . '"><p>' . $title . '</p></td></tr>';
	}
